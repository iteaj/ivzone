#### ivzone 一个更适合 _**个人开发者、后端语言开发者**_ 使用的前端框架(无需编译, 非前后端分离, 基于Vue的传统多页面开发方式)
...
1. 喜欢vue的开发方式, 又不想要编译的开发者
2. 喜欢传统多页面的开发方式， 对spa(单页面)开发方式无感的开发者
3. 想找一套和后台语言无关的， 且完整包含增删改查功能(一个页级视图组件包含完整的增删改查详情等功能)的开发者
#### 说明目录
